...
- Josef Magloire M. Placer (Dxdiag77)
...
Our language supports two types of numeric literals designed to represent game parameters (e.g., player health, coordinates, velocity, and frame counters):
1. Integers (e.g. 7, 90) | Whole signed numbers without a decimal point.
2. Floating-Point Numbers (e.g. 2.77) | Real numbers containing a single decimal point.
